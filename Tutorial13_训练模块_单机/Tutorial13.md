...
直接点击创建好的文件进入编辑界面，点击编辑，把[数据集内容 https://app-store-images.pku.edu.cn/pku-app-store-storage/dataset/identity-pku-assistant.json ](https://app-store-images.pku.edu.cn/pku-app-store-storage/dataset/identity-pku-assistant.json)粘贴到文本框，点击保存。
